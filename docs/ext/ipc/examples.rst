...
Here are some ways to use nextcord-ext-ipc in **your own bot!** For GitHub based examples, see `the examples directory <https://github.com/nextcord/nextcord-ext-ipc/tree/main/examples>`_.
